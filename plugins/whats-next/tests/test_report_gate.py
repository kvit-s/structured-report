...
def another_agent():
    """A second agent, invented for these tests. Claude Code is the only
    adapter this plugin ships, so this stands in for the next one: its tools
    have other names, its card takes up to five options and a longer header,
    and its question tool has been renamed once."""
